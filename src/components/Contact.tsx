    ...
    // <section className="flex-col sm:px-16 px-6 sm:py-16 py-10 max-w-fit mx-auto relative z-0" id='contact'>
        ...
        Let's <span className="text-[#ff8906]">connect</span>
            ...
            <form action="#" className="space-y-8">
                ...
                <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-white dark:text-[#121212] dark:hover:bg-[#ff8906] dark:focus:ring-[#ff8906]" onClick={onSubmit}>Send email</button>
            </form>
        </div>
    // </section>
    )
