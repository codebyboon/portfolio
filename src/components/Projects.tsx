...
const Projects = () => {
    ...
    return (
      <div className='my-auto scroll-mt-28 mt-20' id='projects'>
        ...
        <div className="grid grid-cols-2 px-80 md:grid-cols-3 gap-4">            
          
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-[#2e2f3e] dark:border-[#2e2f3e]">
