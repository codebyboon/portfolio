...
const Card = ({title, heading, description, href}: {title: string, heading: string, description: string, href: string}) => {
  return (
    ...
    <div className="p-6 w-full mb-3 lg:w-screen lg:mx-2 bg-white border border-[#2e2f3e] rounded-lg shadow dark:bg-[#2e2f3e]">
        ...
        {title !== "Education" && (
          <a href={href} className="inline-flex items-center mt-5 px-3 py-2 text-sm font-medium text-center text-[#121212] bg-[blue-700] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#fffffe] dark:hover:bg-[#ff8906] dark:hover:text-[#fffffe] dark:focus:ring-[#ff8906]">
              Read more
