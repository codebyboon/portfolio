    ...
    <section className="flex-col sm:px-16 px-6 sm:py-16 py-10 max-w-fit mx-auto relative z-0 scroll-mt-14" id='about'>
        ...
        <div className="container flex justify-center">
            ...
            <div className="opacity-1 transform-none pl-8">
                ...
                <div className="flex">
                    <h2 className="text-[#fffffe] font-black md:text-6xl sm:text-5xl xs:text-4xl text-3xl">Hi, I'm </h2>
                    <h2 className="text-[#ff8906] font-black md:text-6xl sm:text-5xl xs:text-4xl text-3xl ml-3">Boon</h2>
                    <h2 className="text-[#fffffe] font-black md:text-6xl sm:text-5xl xs:text-4xl text-3xl">!</h2>
                </div>
